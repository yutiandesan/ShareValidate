...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        self.tLabel.font = [UIFont fontWithName:nowFontName size:12];
        self.tLabel.textColor = [lhColor colorFromHexRGB:contentTitleColorStr];
...
- (instancetype)initWithFrame1:(CGRect)frame
{
    ...
    if (self) {
        ...
        self.tLabel.font = [UIFont fontWithName:nowFontName size:14];
        self.tLabel.textColor = [lhColor colorFromHexRGB:contentTitleColorStr];
        [self addSubview:self.tLabel];
    }
    return self;
